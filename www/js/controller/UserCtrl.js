angular.module('starter.UserCtrl', [])
  ...
  //我的简历
  .controller('ReumeCtrl', ['$scope', '$state', '$ionicModal','$cordovaCamera','PromptService', 'Storage', 'YW',function ($scope,$state, $ionicModal,$cordovaCamera,PromptService,Storage,YW) {
    //新增简历
    $scope.nRTitle = '新增简历';
